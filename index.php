...
use \frigorifico\Model\Fornecedor;
...
$app->get("/fornecedores/flavio", function(){
    ...
    $fornecedores = $fornecedor->listFornecedores(); 
...
$app->get("/fornecedores/create", function(){
	...
	$page->setTpl("fornecedores-create", array(
        "lembretes"=>$lembretes,
        "mensagem"=>$mensagem
...
$app->post("/fornecedores/create", function(){
