                    ...
                    <div class="col-xl-12 col-lg-12">
                        <div class="card shadow mb-4">  
                            ...
                            <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                                <h6 class="m-0 font-weight-bold text-primary upper">Pagamentos</h6>
                            </div>
                            
                            <!-- Card Body -->
                            <div class="card-body" width="100%">
                                <div class="mb-3">
                                    <form role="form" action="/pagamentos" method="post">
                                    ...
                                    <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0"  >
                                        ...
                                        <tbody>
                                            <?php $counter1=-1;  if( isset($relatorio) && ( is_array($relatorio) || $relatorio instanceof Traversable ) && sizeof($relatorio) ) foreach( $relatorio as $key1 => $value1 ){ $counter1++; ?><tr class="bg-gray-100">
                                                <td class="text-gray-900"><?php echo htmlspecialchars( $value1["dataPagamento"], ENT_COMPAT, 'UTF-8', FALSE ); ?></td>
                                                ...
                                                <td class="text-gray-900"> R$ <?php echo htmlspecialchars( $value1["valorPagamento"], ENT_COMPAT, 'UTF-8', FALSE ); ?></td>
                                            </tr>
                                            <?php } ?>
                                        <tfoot>
                                            <tr>
                                                <td class="text-gray-900" style="width: 30%;"><b>TOTAL PAGAMENTOS:</b></td>
                                                <td></td> 
