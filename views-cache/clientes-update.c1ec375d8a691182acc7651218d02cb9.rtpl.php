                        ...
                        <div class="card shadow mb-4">
                            ...
                            <div class="modal fade" id="logoutModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"aria-hidden="true">
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">Deseja deletar <b><?php echo htmlspecialchars( $user["nomeCliente"], ENT_COMPAT, 'UTF-8', FALSE ); ?></b>?</div>
                                        <div class="modal-footer">
                                            ...
                                            <a href="/clientes/<?php echo htmlspecialchars( $user["idCliente"], ENT_COMPAT, 'UTF-8', FALSE ); ?>/delete" class="btn btn-success btn-icon-split">
                                                <span class="icon text-white-50">
                            ...
                            <div class="card-body" width="100%">
                                <form role="form" action="/clientes/<?php echo htmlspecialchars( $user["idCliente"], ENT_COMPAT, 'UTF-8', FALSE ); ?>" method="post" > 
                                    <h5><b class="text-gray-900">Nome Cliente</b></h5>
                                    ...
                                    <div class="input-group mb-3">
                                        <input type="text"  name="apelidoCliente" id="apelidoCliente" value="<?php echo htmlspecialchars( $user["apelidoCliente"], ENT_COMPAT, 'UTF-8', FALSE ); ?>" class="form-control bg-light border-4 small" placeholder="Ex: Irmã de...">
                                    </div>
                                    ...
                                    <h5><b class="text-gray-900">Limite</b></h5>
                                    <div class="input-group mb-3">
