...
class Lembrete extends Model {
    ...
    public function createLembrete($dados){
        ...
        $query = "INSERT INTO lembretes (dataLembrete, descricaoLembrete, statusLembrete, promocaoLembrete, idUsuario) VALUES (:dataLembrete, :descricaoLembrete, :statusLembrete, :promocaoLembrete, :idUsuario)";
