...
class Compra extends Model {
    ...
    public static function verificaDias() {
        ...
        $results = $sql->select("SELECT C.dataCompra, C.idCliente, C.descricaoCompra, L.nomeCliente 
                                FROM compra AS C JOIN cliente as L ON L.idCliente = C.idCliente 
                                WHERE dataCompra = :dataCobranca AND statusCompra = 0", array(
